    ...
    return (
        ...
        <>
            ...
            <div className="mb-2  d-flex justify-content-center align-items-center">
                <button className={`${styles.socialRegister}`}><Image width={30} height={30} alt='icon' src={'/Images/social/google.svg'} /></button>
            ...
            <div className="mb-2 ps-2 pe-2 d-flex justify-content-between">
                <div className="form-check">
                    ...
                    <label className="form-check-label" for="defaultCheck1" style={{ fontSize: "14px" }}>
                        Remember me
                    </label>
                </div>
