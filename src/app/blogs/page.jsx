      ...
      <section className='container mb-5'>
        <div className="d-flex justify-content-between align-items-center mb-5">
          ...
          <div className="carousel-container">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" fill="currentColor" className="bi bi-arrow-left" viewBox="0 0 16 16">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" fill="currentColor" className="bi bi-arrow-right" viewBox="0 0 16 16">
